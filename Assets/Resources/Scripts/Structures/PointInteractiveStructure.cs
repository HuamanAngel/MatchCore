...
public class PointInteractiveStructure
{
    ...
    private Dictionary<DirectionMove.OptionMovements,Vector3> _positionEnemies;
    ...
    public Dictionary<DirectionMove.OptionMovements,Vector3> PositionEnemies { get => _positionEnemies; set => _positionEnemies = value; }
    ...
    public PointInteractiveStructure()
    {
        ...
        _positionEnemies = new Dictionary<DirectionMove.OptionMovements,Vector3>();
